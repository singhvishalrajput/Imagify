    ...
    return (
        <div className='fixed top-0 left-0 right-0 bottom-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center'>
            ...
            >
                ...
                <p className='text-small text-center mb-8'>{state === 'Login' ? 'Welcome back! Please sign in to continue' : 'Welcome! Please sign up to continue'}</p>
                ...
                <div className='border px-8 py-2 flex items-center gap-4 rounded-full mt-4'>
